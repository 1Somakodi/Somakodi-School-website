...
export default function SoftwareEngineeringCoursePage() {
  const courseName = "Frontend Essentials";
  ...
  const testimonials = [
    ...
    {
      text: "Front-End Essentials helped me turn theory into real skills. I loved how hands-on the lessons were, and by the end of the course I had a real portfolio to show. I highly recommend it to anyone starting out in web development.",
      name: "Liam D.",
      role: "Frontend Developer",
      image: "/image/blogs/liam.jpg",
    },
    {
      text: "I had no tech background, but this course broke everything down step by step. By the end, I had a portfolio on github I can showcase during interviews and the confidence to apply for front end developer roles and freelance work.",
      name: "Lucas K.",
      role: "React Developer",
      image: "/image/blogs/lucas.jpg",
    },
  ];
    ...
    <main className="bg-gradient-to-b from-slate-50 via-white to-slate-100 text-gray-900">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative group">
          <Card className="overflow-hidden rounded-2xl shadow-xl border-4 border-orange-500 transition-transform duration-500 group-hover:scale-105">
            <Image
              src="/image/blogs/fe.jpg"
              alt="Javascript"
              width={700}
              height={500}
              className="w-full"
            ...
            >
              <CardBody>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl border-2 border-orange-500 overflow-hidden">
                    <Image
                      src={item.image}
                      alt={item.name}
                      width={48}
