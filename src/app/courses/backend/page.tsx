...
export default function SoftwareEngineeringCoursePage() {
  const courseName = "Backend Development";

  const [open, setOpen] = useState<number | null>(1);
  const [faqOpen, setFaqOpen] = useState<number | null>(null);

  const curriculum = [
    { id: 1, title: "Foundations of Backend Development & Python Essentials", content: "Backend development concepts, Python fundamentals, AI-assisted coding, Environment setup." },
    { id: 2, title: "Flask Framework Core Concepts", content: "Flask architecture, Routing & URL handling, Templates & Jinja2, AI integration in workflow." },
    { id: 3, title: "Databases, ORM, and Data Modeling", content: "SQL fundamentals, SQLite & PostgreSQL, SQLAlchemy ORM, AI-augmented data design." },
    { id: 4, title: "Building and Securing RESTful APIs", content: "API architecture, Flask Blueprints, Authentication & authorization, AI-enhanced development." },
    { id: 5, title: "Integrating AI & Automation into Backend Systems", content: "AI integration fundamentals, Building AI-powered endpoints, Data preprocessing for AI, Automation with Python." },
    ...
    { id: 8, title: "Capstone Project & Career Prep", content: "Build a full-stack application and prepare for backend developer roles." },
  ];
  ...
  const testimonials = [
    ...
    {
      text: "What stood out most was the practical AI integration. We didn’t just learn theory — we connected machine learning models to real backend applications using Python and APIs. The mentorship and hands-on projects gave me the confidence to apply for backend roles with an AI focus.",
      name: "Jessica V.",
      role: "Software Engineering Graduate",
      image: "/image/blogs/jessica.jpg",
    },
    {
      text: "This backend course gave me industry-ready skills. From databases and authentication to AI-powered features like recommendations and automation, everything was taught in a clear and practical way. I’m now building smarter applications and standing out in job interviews!",
      name: "Ethan M.",
      role: "Junior Backend Engineer",
      image: "/image/blogs/ethan.jpg",
    },
  ];
...
.
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 mb-8 text-sm">
            <div>
              ...
              <Typography className="font-semibold">12 weeks</Typography>
            </div>
            <div>
