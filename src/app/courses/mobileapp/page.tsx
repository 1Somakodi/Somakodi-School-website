...
export default function SoftwareEngineeringCoursePage() {
  ...
  const testimonials = [
    {
      text: "Before this course, mobile development felt intimidating. Now I can build real Android apps from scratch and understand how everything fits together. The lessons were practical and easy to follow!",
      name: "Davis R.",
      role: "Junior Mobile Developer",
      image: "/image/blogs/davis.jpg",
    },
    {
      text: "This course gave me hands-on experience, not just theory. I built my first working app and published it to my portfolio. It boosted my confidence and opened new career opportunities.",
      name: "Dan G.",
      role: "Mobile App Development Student",
      image: "/image/blogs/Dan.jpg",
    },
    {
      text: "The step-by-step teaching and real projects made learning enjoyable. I went from zero coding knowledge to creating functional mobile apps. Highly recommended for beginners",
      name: "John P.",
      role: "App Development Graduate",
      image: "/image/blogs/allen.jpg",
    },
  ];
